...
module.exports = ({db, express}) => {
    const routes = express.Router()
      ...
      routes.post('/register', (req, res) => {
        ...
        let postRequest = 'INSERT INTO registered (`event_id`, `user_id`, `user_name`, `user_email`, phone, address) VALUES (?,?,?,?,?,?)'
        let values = [event_id, user_id, name, email, phone, address]
        db.query(postRequest, values, (error, result) => {
          if (result) {
      ...
      routes.post('/order', (req, res) => {
        ...
        let postRequest = 'INSERT INTO registered (`event_id`, `user_id`, `user_name`, `user_email`, `donation`, `payment`, `phone`, `address`) VALUES (?,?,?,?,?,?,?,?)'
        let values = [event_id, id, name, email, donation, price, phone, address]
        db.query(postRequest, values, (error, result) => {
          if (result) {
            const DOMAIN = 'ordinarygoddesses.com.au'
            const mg = mailgun({apiKey: config.mailgun, domain: DOMAIN})
